function [RX RY RZ theta1 theta2 l1 l2] = refractionPlaneIterative(x1,y1,z1,X2,Y2,Z2,zo,n1,n2);
% Vectorized iterative solution for refraction through a dieletric interface
...
% zo        z coordinate of dieltric interface
...
% reproject the refraction point in orginal frame
RX = x1 + uhat_x.*u;
RY = y1 + uhat_y.*u;
RZ = zo*ones(sz);
