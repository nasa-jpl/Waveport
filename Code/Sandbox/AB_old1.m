...
% Vector translation matrices (via scalar translation matrix)
%
% L,Lp:     maximum order l in row and column
% k:		background wave number
% rji:		[x,y,z] vector from the origin to the receiving frame
...
% compute alpha for L1+1, and L2+1
